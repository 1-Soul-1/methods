...
# Готовые методы Ньютьона и Лагранжа - интреполяция из scipy
# Scipy - надстройка над numpy(науная библиотека дл\ работы с тяжёлыми вычислительными данными)
import numpy as np
